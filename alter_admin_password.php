...
<body>
	...
	<div id="alter_box">
		<center>
		<form name="alterForm" action="php/audit_action/AlterAdminPassword.php" method="post">
			<div class="title"><img src="image/operate.png" title="修改密码"/>修改密码</div>
			<div><label>账号</label><input type="text" name="admin_id" readonly="true" value=<?php @session_start();echo $_SESSION['admin'];?> /></div>
